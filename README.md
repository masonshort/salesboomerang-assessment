...
Runs yarn client-start and yarn run server using concurrently.\
This is the command you use to run the full project.
...
Runs server.js using nodemon.\
This handles the API call to get the list of colors.
